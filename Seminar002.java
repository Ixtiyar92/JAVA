public class Seminar002 {
    public static void main(String[] args){
        ...
        StringBuilder builder = new StringBuilder("Help World! My name is Евгений");
        s = builder.toString(); // преобразует содержимое StringBuilder просто в строку String
        builder.append("!");
